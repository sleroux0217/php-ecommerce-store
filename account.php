  ...
  <div class="container">
    <div class="row">
      <?php if (isset($_GET['payment_message'])) { ?>
        <p class="mt-5 text-center text-success"><?php echo $_GET['payment_message']; ?></p>
      <?php } ?>

      <div class="col-lg-6 col-md-12 col-sm-12 text-center mt-3 pt-5">
        <p class="text-success"><?php if (isset($_GET['register_success'])) echo $_GET['register_success']; ?></p>
        ...
        <tr>
          ...
          <td>
            <form method="POST" action="order_details.php">
              ...
              <input class="btn btn-info" name="order_details_btn" type="submit" value="Details" />
            </form>
          </td>
        </tr>
      <?php } ?>
